...
namespace AnimalTest
{
    ...
    public class AnimalTests
    {
        ...
        public void Cow_AddAnimal_AddsCowToDatabase()
        {
            ...
            // Assert
            Assert.AreEqual(initialCowCount + 1, updatedCowCount, "Cow count should increase after adding");
        }
        ...
        public void Cow_DeleteAnimal_RemovesCowFromDatabase()
        {
            ...
            Assert.AreEqual(initialCowCount - 1, updatedCowCount, "Cow count should decrease after deletion");
        }
        ...
        public void Goat_AddAnimal_AddsGoatToDatabase()
        {
            ...
            Assert.AreEqual(initialGoatCount + 1, updatedGoatCount, "Goat count should increase after adding");
        }
        ...
        public void Goat_DeleteAnimal_RemovesGoatFromDatabase()
        {
            ...
            Assert.AreEqual(initialGoatCount - 1, updatedGoatCount, "Goat count should decrease after deletion");
        }
        ...
        public void Hen_AddAnimal_AddsHenToDatabase()
        {
            ...
            Assert.AreEqual(initialHenCount + 1, updatedHenCount, "Hen count should increase after adding");
        }
        ...
        public void Hen_DeleteAnimal_RemovesHenFromDatabase()
        {
            ...
            Assert.AreEqual(initialHenCount - 1, updatedHenCount, "Hen count should decrease after deletion");
        }
    }
}